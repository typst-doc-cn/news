...
#link-news("content/news/2025-06/gap.zh-CN.typ")[之前介绍过]，这份文档描述 typst 在中文支持方面的差距，特别是排版和参考文献著录。
...
#link-news("content/news/2025-06/gap.zh-CN.typ#:~:text=空隙过宽-,隐藏问题,-此外，我认为")[之前提到]，中文习惯的引用编号格式是`[1]`。在 Typst v0.13.1，`1`可能向上飘出`[]`，严重程度取决于具体设置。
